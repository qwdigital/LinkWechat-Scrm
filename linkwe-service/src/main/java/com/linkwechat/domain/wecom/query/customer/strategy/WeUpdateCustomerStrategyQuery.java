...
@Data
public class WeUpdateCustomerStrategyQuery extends WeBaseQuery {
     ...
     * 管理范围
     */
    private WeCustomerStrategyRangeEntity range_add;

    private WeCustomerStrategyRangeEntity range_del;
}
