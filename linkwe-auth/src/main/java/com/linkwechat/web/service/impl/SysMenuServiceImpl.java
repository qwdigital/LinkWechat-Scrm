...
import com.linkwechat.web.domain.vo.MetaVo;
import com.linkwechat.web.domain.vo.RouterVo;
import com.linkwechat.web.mapper.SysMenuMapper;
import com.linkwechat.web.mapper.SysRoleMenuMapper;
import com.linkwechat.web.service.ISysMenuService;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<SysMenu> selectMenuList(SysMenu menu, Long userId) {
        ...
        // 管理员显示所有菜单信息
        if (SecurityUtils.isAdminUser() || (SecurityUtils.getUserType() != null && SecurityUtils.getUserType().equals("00"))) {
     ...
     */
    @Override
    public List<SysMenu> selectAllMenuList(SysMenu menu){
    ...
    public List<Integer> selectMenuListByRoleId(Long roleId) {
        return menuMapper.selectMenuListByRoleId(roleId).stream().map(menu -> {
