...
@Slf4j
@Component
public class WeAppAccessTokenInterceptor extends WeForestInterceptor implements Interceptor<WeResultVo> {
    ...
    public void onRetry(ForestRequest request, ForestResponse response) {
        ...
        if (!ObjectUtil.equal(WeErrorCodeEnum.ERROR_CODE_OWE_1.getErrorCode(), weResultVo.getErrCode())
            ...
            iQwAccessTokenService.removeCommonAccessToken(getCorpId(request));
