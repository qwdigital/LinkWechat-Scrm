 ...
 * @date 2021/4/5 15:47
 **/
@BaseRequest(baseURL = "${wxServerUrl}",interceptor = WeiXinAuthInterceptor.class)
public interface WxAuthClient {
    ...
    WxTokenVo getAuthToken(@Query("appid") String appId, @Query("secret") String secret,
    ...
    WxTokenVo refreshToken(@Query("appid") String appId, @Query("grant_type") String grantType,
    ...
    WxTokenVo auth(@Query("openid") String openId);
    ...
    WxAuthUserInfoVo getUserInfo(@Query("openid") String openId, @Query("lang") String lang);
