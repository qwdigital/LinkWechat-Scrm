 ...
 */
@Service
public class WeGroupCodeActualServiceImpl implements IWeGroupCodeActualService 
{
    @Autowired
    ...
    {
        return weGroupCodeActualMapper.updateWeGroupCodeActual(weGroupCodeActual);
    }
