...
//    public void dataExport(@RequestBody WeFormSurveyStatisticQuery query) {
//
//        List<WeFormSurveyStatistics> weFormSurveyStatistics = weFormSurveyStatisticsService.dataList(query);
//
//        LwExcelUtil.exprotForWeb(
//                ServletUtils.getResponse(), WeFormSurveyStatistics.class,weFormSurveyStatistics,"数据报表_" + System.currentTimeMillis()
//        );
//
////        String type = query.getType();
...
//    public void answerExport(WeFormSurveyStatisticQuery query) throws IOException, IOException {
//        //时间类型处理
//        String type = query.getType();
//        if (StringUtils.isNotBlank(type) && type.equals("week")) {
//            query.setStartDate(DateUtil.offsetWeek(new Date(), -1));
