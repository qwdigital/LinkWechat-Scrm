...
//
    ...
    public AjaxResult editWelComeMsg(@RequestBody WeDefaultWelcomeMsgVo welcomeMsgVo){
        iWeDefaultWelcomeMsgService.saveOrUpdateBatchWeComeMsg(welcomeMsgVo.getAttachments());
        return AjaxResult.success();
    }
