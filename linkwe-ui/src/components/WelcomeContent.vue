        ...
        <el-form label-width="110px" label-position="right">
          <div class="g-card g-pad20">
            <el-form-item label="使用员工" required v-if="showMember">
              <el-tag sizi="mini" v-for="(unit, key) in form.users" :key="key">{{
                unit.userName
              }}</el-tag>
              <div>
          ...
          <div class="g-card g-pad20" v-for="(item, index) in form.materialMsgList" :key="index">
            ...
            <div class="my-cord" v-if="item.msgType == '4'">
              <div class="operation">
                <div
                  v-if="showMorMaterial"
                  class="algin"
                  @click="onChooseMaterial(item.msgType, index)"
                >
                  <img
                    style="margin-right: 3px"
                    :src="require('@/assets/drainageCode/code-add.png')"
          ...
          <div
            ...
            v-show="form.materialMsgList.length <= 8 && showMore()"
          >
  ...
  methods: {
    ...
    onInsert(val) {
      ...
      if (val) {
        ...
        this.form.welcomeMsg = this.strType
          ? msg.replace(/\%NICKNAME\%/, '')
          : msg.replace(/\#客户昵称\#/, '')
      }
    },
