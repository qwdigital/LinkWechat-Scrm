<template>
  <div class="index">
        ...
        <div style="text-align:left">
          <el-row type="flex" class="row-bg" justify="space-between">
            <el-col :span="24" style="font-weight:bold"
              >实时数据
              <span class="fr fontgay">更新于{{ uptime }}</span></el-col
            >
          </el-row>
          <el-row type="flex" class="row-bg" justify="space-between">
            <el-col :span="24">
          ...
          >
            <el-col :span="6"
              ...
              <i
                :class="{
                  'el-icon-top': Number(erchatsTable.newApplyCntDiff) >= 1,
                  'el-icon-bottom': Number(erchatsTable.newApplyCntDiff) < 0,
                  redicon: Number(erchatsTable.newApplyCntDiff) >= 1,
                  greenicon: Number(erchatsTable.newApplyCntDiff) < 0,
                }"
              ></i>
              <span
                :class="{
                ...
                >{{ erchatsTable.newApplyCntDiff }}</span
              >
            </el-col>
            <el-col :span="6"
              >比{{ time }}
              <i
                :class="{
                  'el-icon-top': Number(erchatsTable.newContactCntDiff) >= 1,
                  'el-icon-bottom': Number(erchatsTable.newContactCntDiff) < 0,
                  redicon: Number(erchatsTable.newContactCntDiff) >= 1,
                  greenicon: Number(erchatsTable.newContactCntDiff) < 0,
                }"
              ></i>
              <span
                :class="{
                ...
                >{{ erchatsTable.newContactCntDiff }}</span
              >
            </el-col>
            <el-col :span="6"
              >比{{ time }}
              <i
                :class="{
                  'el-icon-top': Number(erchatsTable.newMemberCntDiff) >= 1,
                  'el-icon-bottom': Number(erchatsTable.newMemberCntDiff) < 0,
                  redicon: Number(erchatsTable.newMemberCntDiff) >= 1,
                  greenicon: Number(erchatsTable.newMemberCntDiff) < 0,
                }"
              ></i>
              <span
                :class="{
            ...
            <el-col :span="6"
              ...
              <i
                :class="{
                  'el-icon-top':
                    Number(erchatsTable.negativeFeedbackCntDiff) >= 1,
                  'el-icon-bottom':
                    Number(erchatsTable.negativeFeedbackCntDiff) < 0,
                  redicon: Number(erchatsTable.negativeFeedbackCntDiff) >= 1,
                  greenicon: Number(erchatsTable.negativeFeedbackCntDiff) < 0,
                }"
              ></i>
              <span
                :class="{
                ...
                >{{ erchatsTable.negativeFeedbackCntDiff }}</span
              >
            </el-col>
          </el-row>
          <el-row
    ...
    <div class="index_r whitebg">
      ...
      <div class="twolink">
        <div class="twolinkbox" style="color: orange">
          <i class="el-icon-warning-outline"></i> <span>帮助文档</span>
        </div>
        <div class="twolinkbox" style="float:right;color:#199ed8">
          <i class="el-icon-s-management"></i><span>开发文档</span>
        </div>
      </div>
      <div class="listcard">
        <div class="inedx_r_top_bottom">
