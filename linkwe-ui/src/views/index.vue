    ...
    <div class="index_l whitebg">
      ...
      <div class="tables">
        <div style="text-align:left">
          <el-row type="flex" class="row-bg" justify="space-between">
            <el-col :span="24" class="title_name">数据总览
          ...
          <el-row type="flex" class="row-bg" justify="space-between" style="margin-top:10px;font-size:35px;font-weight:bold;color:#0079DE; text-align: center;">
            <el-col :span="6">
      ...
      <div class="dataall" style="margin-top:10px">
        <div style="text-align:left">
          ...
          <el-row type="flex" class="row-bg" justify="space-between" style="margin-top:10px;font-size:35px;font-weight:bold;color: #0079DE; text-align: center;">
            ...
            <el-col :span="6">{{ erchatsTable.newMemberCnt ? erchatsTable.newMemberCnt : 0 }}
            </el-col>
      ...
      <div class="car card">
        <el-row type="flex" justify="space-between">
          <el-col :span="24" style="font-size: 24px; line-height:80px
">快捷功能
          </el-col>
        </el-row>
        <el-row :gutter="20">
      ...
      <div class="qy_R">
        <div class="inedx_r_top_t">
          ...
          <el-row :gutter="20" type="flex" class="row-bg" justify="center" style="text-align:center">
            ...
            <el-col :span="10" class="flexspan" @click.native="msgInfo('《使用手册》正在加急上线中，敬请关注…')"><img src="../assets/index/kfsc.png" /> 开发文档</el-col>
          </el-row>
        </div>
