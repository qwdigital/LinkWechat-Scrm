    ...
    <div style="margin-top: 0;background-color: #FFFFFF;">
      ...
      <div class="g-card g-m20">
        ...
        <el-table v-loading="importLoading" :data="importList" max-height="600">
          <el-table-column label="导入表格名称" align="center" prop="tableExcelName" min-width="180px" show-overflow-tooltip />
          <el-table-column label="导入客户总数" align="center" prop="cutomerTotalNum" show-overflow-tooltip />
          <el-table-column label="导入时间" align="center" prop="createTime" show-overflow-tooltip width="180"></el-table-column>
      ...
      <div class="g-card g-m20">
        ...
        <el-table v-loading="addLoading" :data="addList" max-height="600">
          ...
          <el-table-column label="待添加客户数" align="center" prop="waitAddCustomerNum" show-overflow-tooltip></el-table-column>
          <el-table-column label="待通过客户数" align="center" prop="waitPassCustomerNum" width="180">
          </el-table-column>
          <el-table-column label="已添加客户数" align="center" prop="addCustomerNum" show-overflow-tooltip />
