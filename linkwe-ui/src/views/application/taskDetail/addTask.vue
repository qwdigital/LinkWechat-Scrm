...
export default {
    name: 'editTask',
    components: { SelectUser, SelectTag, SelectPoster, TargetSelectUser: SelectUser },
    data () {
        return {
            query: {
                taskName: "",
            ...
            ruleForm: {
                ...
                postersId: [
                    { required: true, message: '请输入海报', trigger: 'blur' },
                ],
                fissNum: [
            ...
            >
                ...
                >
                    ...
                    <div v-if="groupForm.tagType">
                        <el-tag
                            v-for="(item) in groupForm.customerTag"
                            :key="item"
                        >{{item}}</el-tag>
                    </div>
                </el-form-item>
        ...
        <div class="edit-model">
            ...
            >
                ...
                >
                    ...
                    <div
                        v-if="groupForm.postersId"
                        class='changePosterBody'
                    >
                        <img
                            :src="groupForm.postersUrl"
                            class='postersUrl'
                        />
                        <span
                            class='changeUrl'
                ...
                <el-form-item label="添加员工">
                    ...
                    <p class="targetTips">选择员工，用于此次任务裂变的目标添加人。如不选择将默认使用本次活动下发员工的活码信息。</p>
                </el-form-item>
            </el-form>
        </div>
        <div class="edit-model">
